...
function preload(){
  backgroundIMG = loadImage("images/ironbg.png");
  backgroundIMG2 = loadImage("images/wp.jpg");
  ...
  boostIMG = loadImage("images/life.png");
...
function draw() {
  ...
  if(gameState === 0){
      ...
      fill("red");
      textSize(10);
      text("Note:This game is a story based on 'END GAME'.", 0, 350);
      strokeWeight(4);
      stroke("blue");
      fill("white")
      textSize(15);
