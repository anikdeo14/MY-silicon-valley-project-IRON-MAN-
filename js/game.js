class Game{
    ...
    start(){
        ...
        info = createSprite(80,450,10,10);
    ...
    setLevel1(){
        ...
        astroJet = createSprite(200,570,10,10);
    ...
    playLevel1(){
      ...
      if(laser1Group.isTouching(astroJet)){
        laser1Group.remove();
        lives = lives - 1;
        DieSound.play();
      }
    ...
    textSize(25)
    text("!Congratulations!",110,300);

    textSize(22)
    text("YOU WON!",155,350);
    WinSound.play();
